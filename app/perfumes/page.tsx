        ...
        <div className="relative z-10 container mx-auto flex flex-col items-center justify-center flex-grow py-12 sm:py-16">
          <div className="max-w-2xl lg:max-w-3xl mx-auto">
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl font-bold text-gray-800 mb-6 sm:mb-8">
              FindYourScent&rsquo;e Hoş Geldiniz
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              <Link
                ...
                className="group relative inline-flex items-center justify-center px-7 py-3.5 sm:px-8 sm:py-4 text-base sm:text-lg font-medium text-white bg-amber-600 hover:bg-amber-700 rounded-full shadow-lg transition-all duration-300"
              >
              ...
              <Link
                href="/perfumes"
                className="group relative inline-flex items-center justify-center px-7 py-3.5 sm:px-8 sm:py-4 text-base sm:text-lg font-medium text-amber-700 border-2 border-amber-600 bg-white/70 hover:bg-amber-100 hover:text-amber-900 rounded-full shadow-lg transition-all duration-300"
              >
                Tüm Parfümler
              </Link>
            </div>
        ...
        <section className="py-16 md:py-24 bg-gray-50"> {/* Arka plan rengi değiştirildi */}
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-12 md:mt-16">
              <Link
                href="/perfumes"
                className="inline-block border-2 border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-white font-sans font-semibold py-3 px-8 rounded-lg transition-all duration-300 text-lg"
              >
                Tüm Koleksiyonu Gör
              </Link>
            </div>
